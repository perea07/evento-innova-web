...
function Hero(){
  return (
    <section className="rounded-3xl overflow-hidden bg-[url('https://images.unsplash.com/photo-1526378721066-196a46b14b36?w=1600&q=60')] bg-cover bg-center p-8 md:p-12 lg:p-20 text-azul-nocturno" style={{backgroundColor: 'transparent'}}>
      <div className="backdrop-blur-sm bg-white/80 rounded-2xl p-6 md:p-12">
        <div className="max-w-3xl">
          <h1 className="text-3xl md:text-5xl font-extrabold">Innova U — Encuentro de Innovación y Tecnología</h1>
          <p className="mt-3 text-sm md:text-base opacity-90">24 Nov · Universidad Central · Regístrate gratis</p>

          <div className="mt-6 flex gap-4">
            <Link to="/registro" className="bg-cian-electrico text-azul-nocturno px-5 py-3 rounded-lg font-bold">Inscribirme</Link>
            <Link to="/agenda" className="px-5 py-3 rounded-lg border border-white/10">Ver agenda</Link>
          </div>
        </div>
      </div>
    </section>
